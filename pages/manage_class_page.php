            ...
            <div class="flex justify-center items-center mt-[10vh]">
                <div class="w-[80%]">
                    <div class="flex justify-between items-center">
                        <h1 class="font-bold text-[2em]">Manage Class</h1>
                        <div>
                    ...
                    <div class="mt-5">
                        <div class="m-3">
                            <p class="text-lg font-semibold mb-2">Class ID:</p>
                        ...
                        <div class="m-3">
                            <p class="text-lg font-semibold mb-2">Class Name:</p>
                            <div class="border-2 border-slate-500 rounded-xl px-2 py-1">
                                <label for="icon-name"><i class="fa-solid fa-signature px-2 py-2"></i></label>
                    ...
                    <table class="w-full border-2 text-center border-slate-500">
                        <thead>
                            <tr>
                                ...
                                <th class="border-2 border-slate-500">Class Name</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td class="border-2 border-slate-500"><?php echo $class['c_id']; ?></td>
                                    <td class="border-2 border-slate-500"><?php echo $class['c_name']; ?></td>
                                    <td class="border-2 border-slate-500 py-4 flex justify-center gap-4">
                                        <button class="edit-button bg-sky-500 p-3 text-white font-semibold" data-id="<?php echo $class['c_id']; ?>">Edit</button>
                                        ...
                                        <div id="edit-modal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 hidden">
                                            <div class="bg-white p-8 rounded-lg shadow-md">
                                                ...
                                                <form id="edit-form" action="../libs/edit_class.php" method="post" enctype="multipart/form-data">
                                                    <input type="hidden" name="class_id" id="edit-student-id">
                                                    <div class="m-3">
                                                        <p class="text-lg font-semibold mb-2">New Class Name:</p>
                                                        <div class="border-2 border-slate-500 rounded-xl px-2 py-1">
                                                            <label for="icon-name"></label>
                                                            <input class="focus:outline-none px-2 py-2 w-[30vh]" type="text" name="classname" id="classname" required>
                                                        </div>
                                                    </div>
                                                    <div class="mt-4">
