            ...
            <div class="flex justify-center items-center mt-[10vh]">
                <div class="w-[80%]">
                    <div class="flex justify-between items-center">
                        <h1 class="font-bold text-[2em]">Manage Student</h1>
                        <div>
                    ...
                    <div class="mt-5">
                        <div class="m-3">
                            <p class="text-lg font-semibold mb-2">ID:</p>
                        ...
                        <div class="m-3">
                            <p class="text-lg font-semibold mb-2">Full Name:</p>
                            <div class="border-2 border-slate-500 rounded-xl px-2 py-1">
                                <label for="icon-name"><i class="fa-solid fa-signature px-2 py-2"></i></label>
                        ...
                        <div class="m-3">
                            <p class="text-lg font-semibold mb-2">Class:</p>
                            <div class="border-2 border-slate-500 rounded-xl px-2 py-1">
                                <label for="icon-name"><i class="fa-solid fa-signature px-2 py-2"></i></label>
                        ...
                        <div class="m-3">
                            <p class="text-lg font-semibold mb-2">Birthday:</p>
                            <div class="border-2 border-slate-500 rounded-xl px-2 py-1">
                        ...
                        <div class="m-3">
                            <p class="text-lg font-semibold mb-2">Image:</p>
                            <div class="border-2 border-slate-500 rounded-xl px-2 py-1">
                    ...
                    <table class="w-full border-2 text-center border-slate-500">
                        <thead>
                            <tr>
                                ...
                                <th class="border-2 border-slate-500">Full Name</th>
                                <th class="border-2 border-slate-500">Class</th>
                                <th class="border-2 border-slate-500">Birthday</th>
                                <th class="border-2 border-slate-500">Image</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td class="border-2 border-slate-500"><?php echo $student['s_id']; ?></td>
                                    <td class="border-2 border-slate-500"><?php echo $student['s_name']; ?></td>
                                    <td class="border-2 border-slate-500"><?php echo $student['s_class']; ?></td>
                                    <td class="border-2 border-slate-500"><?php echo $student['s_birth']; ?></td>
                                    <td class="border-2 border-slate-500">
                                        ...
                                        <div id="edit-modal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 hidden">
                                            <div class="bg-white p-8 rounded-lg shadow-md">
                                                ...
                                                <form id="edit-form" action="../libs/edit.php" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="m-3">
                                                        <p class="text-lg font-semibold mb-2">New Name:</p>
                                                        <div class="border-2 border-slate-500 rounded-xl px-2 py-1">
                                                    ...
                                                    <div class="m-3">
                                                        <p class="text-lg font-semibold mb-2">New Class</p>
                                                        <div class="border-2 border-slate-500 rounded-xl px-2 py-1">
                                                            <label for="icon-name"></label>
